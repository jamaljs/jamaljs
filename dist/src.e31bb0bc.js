...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"uniqid.js":[function(require,module,exports) {
...
Jml.create = function (selector, markup) {
  var _this = this;
...
Jml.initialize = function (_ref) {
  ...
  if (customTags.length > 0) {
    customTags.forEach(function (customTag) {
      return tags.push(function (_) {
        if (!_.includes('-')) return _;
        var parts = customTag.split('-').map(function (x) {
          return x.replace(/^./, function (fc) {
  ...
  tags.forEach(function (tag) {
    window["j".concat(tag.replace(/^./, function (firstCharacter) {
      ...
      if (config.debug) {
        console.group("Element: ".concat(tag));
...
module.exports = Jml;
},{"./uniqid":"uniqid.js"}],"../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], "Jml")
